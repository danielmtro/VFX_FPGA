...
function  output = FIR_filter_mlab(stimulation, bank);
 coef_matrix_in= [0,0,1,2,4,6,10,14,19,25,33,41,49,59,69,78,88,97,105,113,119,123,126,127,126,123,119,113,105,97,88,78,69,59,49,41,33,25,19,14,10,6,4,2,1,0,0];
 INTER_FACTOR  = 1;
 DECI_FACTOR  =  2;
 MSB_RM  = 0;
 MSB_TYPE  = 0;
