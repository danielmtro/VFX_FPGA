...
scaler uscaler (
		input  wire        din_startofpacket,  //         din.startofpacket
		input  wire        din_endofpacket,    //            .endofpacket
		input  wire        din_valid,          //            .valid
		output wire        din_ready,          //            .ready
		input  wire [11:0] din_data,           //            .data
		input  wire        dout_ready,         //        dout.ready
		output wire        dout_startofpacket, //            .startofpacket
		output wire        dout_endofpacket,   //            .endofpacket
		output wire        dout_valid,         //            .valid
		output wire [11:0] dout_data,          //            .data
		output wire [1:0]  dout_channel,       //            .channel
		input  wire        ov7670_pclk_clk,    // ov7670_pclk.clk
